...
# Used by ECS to pull images and retrieve secrets
# -----------------------------------------------------------------------------
...
# Policy for accessing Secrets Manager secrets
    ...
    Statement = [
      {
        ...
        Resource = concat(
          ...
          var.sso_enabled ? [aws_secretsmanager_secret.sso_secrets[0].arn] : []
        )
      },
      {
        Effect = "Allow"
